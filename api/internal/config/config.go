...
type Config struct {
	...
	VPNLocalIP string
	// ServerPublicIP is the VPN server's public IP (used by L2TP template connect-to).
	ServerPublicIP string
	// L2TPPSK is the shared L2TP/IPsec pre-shared key for IKEv1 transport mode.
	L2TPPSK string
	// API_KEY is the shared secret for authenticating API requests (required).
	APIKey string
	// L2TPPSK is the pre-shared key for L2TP/IPsec transport mode (default "vpn-l2tp-psk").
	L2TPPSK string
	// ServerIP is the public IP address of the VPN server, used in RouterOS L2TP templates (required for L2TP).
	ServerIP string
	...
	EncryptionKey []byte
	// EncryptionKeyAutoGenerated is true when ENCRYPTION_KEY was not set via
	// environment and a key was auto-generated. Exposed in /healthz warnings.
	EncryptionKeyAutoGenerated bool
}
...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		ServerPublicIP:            envOr("SERVER_PUBLIC_IP", ""),
		L2TPPSK:                   envOr("L2TP_PSK", "vpn-l2tp-psk"),
		APIKey:                   apiKey,
		L2TPPSK:                  envOr("L2TP_PSK", "vpn-l2tp-psk"),
		ServerIP:                 envOr("SERVER_PUBLIC_IP", ""),
		EncryptionKey:            cryptoKey,
		EncryptionKeyAutoGenerated: keyAutoGenerated,
	}
